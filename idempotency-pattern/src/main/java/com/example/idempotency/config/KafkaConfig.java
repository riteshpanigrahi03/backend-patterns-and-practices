...
public class KafkaConfig {
    ...
    @Bean
    public KafkaAdmin.NewTopics idempotencyTopics(@Value("${app.kafka.order-topic}") String orderTopic) {
        return new KafkaAdmin.NewTopics(new NewTopic(orderTopic, 1, (short) 1));
    }
}
